...
private object ChatEntityMapper : BiMapper<ChatEntity, LoungeChatData> {
...
internal fun ChatEntity.asData(): LoungeChatData {
  return ChatEntityMapper.mapToRight(this)
}

internal fun LoungeChatData.asEntity(): ChatEntity {
